...
INSTALLATION:
#######################
There 2 ways to install correctly this mod ... You must install in this 2 ways or you will probably get a fail.
	
        --> Take all folders "lua,materials,sound" and put theses in :
	1st :
	garrysmod/garrysmod/addons/acf		-->"Acf addons"
	2nd : 
	garrysmod/garrysmod			-->"Main garrysmod"

----> Say yes to override all existing files if exist
----> Take note, you do not need the MOD Client side, if you install it on a server, only the texture pack run client side for everyone.
----> Make sure to make BACKUP of every files
----> If you don't want the texture pack, don't install the Materials Folder
