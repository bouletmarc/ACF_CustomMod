...
local Engine29I5= {}
	Engine29I5.id = "2.9-I5"
	Engine29I5.ent = "acf_engine"
	Engine29I5.type = "Mobility"
	Engine29I5.name = "2.9L I5 Diesel - Temp model"
	Engine29I5.desc = "Car use 5 cylinder, good on fuel and torque."
	Engine29I5.model = "models/engines/inline6s.mdl"
	Engine29I5.sound = "ACF_engines/i5_dieselsmall2.wav"
	Engine29I5.category = "I5"
	Engine29I5.weight = 190
	Engine29I5.torque = 250		--in Meter/Kg
	Engine29I5.flywheelmass = 0.5
	
	Engine29I5.idlerpm = 500	--in Rotations Per Minute
	Engine29I5.peakminrpm = 900
	Engine29I5.peakmaxrpm = 2800
	Engine29I5.limitprm = 4200
	if ( CLIENT ) then
		Engine29I5.guicreate = (function( Panel, Table ) ACFEngineGUICreate( Table ) end or nil)
		Engine29I5.guiupdate = function() return end
	end
MobilityTable["2.9-I5"] = Engine29I5

local Engine41I5= {}
	Engine41I5.id = "4.1-I5"
	Engine41I5.ent = "acf_engine"
	Engine41I5.type = "Mobility"
	Engine41I5.name = "4.1L I5 Diesel - Temp model"
	Engine41I5.desc = "Commercial duty five cylinder, used in various trucks."
	Engine41I5.model = "models/engines/inline6m.mdl"
	Engine41I5.sound = "ACF_engines/i5_dieselmedium.wav"
	Engine41I5.category = "I5"
	Engine41I5.weight = 400
	Engine41I5.torque = 580		--in Meter/Kg
	Engine41I5.flywheelmass = 1.5
	
	Engine41I5.idlerpm = 650	--in Rotations Per Minute
	Engine41I5.peakminrpm = 1000
	Engine41I5.peakmaxrpm = 3200
	Engine41I5.limitprm = 3800
	if ( CLIENT ) then
		Engine41I5.guicreate = (function( Panel, Table ) ACFEngineGUICreate( Table ) end or nil)
		Engine41I5.guiupdate = function() return end
	end
MobilityTable["4.1-I5"] = Engine41I5

local Engine23I5= {}
	Engine23I5.id = "2.3-I5"
	Engine23I5.ent = "acf_engine"
	Engine23I5.type = "Mobility"
	Engine23I5.name = "2.3L I5 Petrol - Temp model"
	Engine23I5.desc = "General car use inline five, not very good on gas."
	Engine23I5.model = "models/engines/inline6s.mdl"
	Engine23I5.sound = "ACF_engines/i5_petrolsmall.wav"
	Engine23I5.category = "I5"
	Engine23I5.weight = 130
	Engine23I5.torque = 200		--in Meter/Kg
	Engine23I5.flywheelmass = 0.12
	
	Engine23I5.idlerpm = 900	--in Rotations Per Minute
	Engine23I5.peakminrpm = 3600
	Engine23I5.peakmaxrpm = 5900
	Engine23I5.limitprm = 7000
	if ( CLIENT ) then
		Engine23I5.guicreate = (function( Panel, Table ) ACFEngineGUICreate( Table ) end or nil)
		Engine23I5.guiupdate = function() return end
	end
MobilityTable["2.3-I5"] = Engine23I5

local Engine39I5= {}
	Engine39I5.id = "3.9-I5"
	Engine39I5.ent = "acf_engine"
	Engine39I5.type = "Mobility"
	Engine39I5.name = "3.9L I5 Petrol - Temp model"
	Engine39I5.desc = "Large performance inline 5, a bastard of an engine. Penis."
	Engine39I5.model = "models/engines/inline6m.mdl"
	Engine39I5.sound = "ACF_engines/i5_petrolmedium.wav"
	Engine39I5.category = "I5"
	Engine39I5.weight = 130
	Engine39I5.torque = 355		--in Meter/Kg
	Engine39I5.flywheelmass = 0.25
	
	Engine39I5.idlerpm = 900	--in Rotations Per Minute
	Engine39I5.peakminrpm = 3700
	Engine39I5.peakmaxrpm = 6000
	Engine39I5.limitprm = 7000
	if ( CLIENT ) then
		Engine39I5.guicreate = (function( Panel, Table ) ACFEngineGUICreate( Table ) end or nil)
		Engine39I5.guiupdate = function() return end
	end
MobilityTable["3.9-I5"] = Engine39I5


--V10s

local Engine43V10 = {}
	Engine43V10.id = "4.3-V10"
	Engine43V10.ent = "acf_engine"
	Engine43V10.type = "Mobility"
	Engine43V10.name = "4.3L V10 Petrol - Temp model"
	Engine43V10.desc = "Small, medium performance V10"
	Engine43V10.model = "models/engines/v12s.mdl"
	Engine43V10.sound = "ACF_engines/v10_petrolsmall.wav"
	Engine43V10.category = "V10"
	Engine43V10.weight = 200
	Engine43V10.torque = 300		--in Meter/Kg
	Engine43V10.flywheelmass = 0.2
	
	Engine43V10.idlerpm = 900	--in Rotations Per Minute
	Engine43V10.peakminrpm = 3500
	Engine43V10.peakmaxrpm = 5800
	Engine43V10.limitprm = 6250
	if ( CLIENT ) then
		Engine43V10.guicreate = (function( Panel, Table ) ACFEngineGUICreate( Table ) end or nil)
		Engine43V10.guiupdate = function() return end
	end
MobilityTable["4.3-V10"] = Engine43V10
local Engine80V10 = {}
	Engine80V10.id = "8.0-V10"
	Engine80V10.ent = "acf_engine"
	Engine80V10.type = "Mobility"
	Engine80V10.name = "8.0L V10 Petrol - Temp model"
	Engine80V10.desc = "High performance V10 engine"
	Engine80V10.model = "models/engines/v12m.mdl"
	Engine80V10.sound = "ACF_engines/v10_petrolmedium.wav"
	Engine80V10.category = "V10"
	Engine80V10.weight = 350
	Engine80V10.torque = 560		--in Meter/Kg
	Engine80V10.flywheelmass = 0.5
	
	Engine80V10.idlerpm = 700	--in Rotations Per Minute
	Engine80V10.peakminrpm = 3400
	Engine80V10.peakmaxrpm = 5500
	Engine80V10.limitprm = 6500
	if ( CLIENT ) then
		Engine80V10.guicreate = (function( Panel, Table ) ACFEngineGUICreate( Table ) end or nil)
		Engine80V10.guiupdate = function() return end
	end
MobilityTable["8.0-V10"] = Engine80V10
local Engine220V10 = {}
	Engine220V10.id = "22.0L-V10"
	Engine220V10.ent = "acf_engine"
	Engine220V10.type = "Mobility"
	Engine220V10.name = "22.0 V10 Diesel - Temp model"
	Engine220V10.desc = "A more modern engine, utilizing fuel injection and ten cylinders"
	Engine220V10.model = "models/engines/v12l.mdl"
	Engine220V10.sound = "ACF_engines/v10_diesellarge.wav"
	Engine220V10.category = "V10"
	Engine220V10.weight = 1400
	Engine220V10.torque = 2300		--in Meter/Kg
	Engine220V10.flywheelmass = 5
	
	Engine220V10.idlerpm = 425	--in Rotations Per Minute
	Engine220V10.peakminrpm = 600
	Engine220V10.peakmaxrpm = 1800
	Engine220V10.limitprm = 3000
	if ( CLIENT ) then
		Engine220V10.guicreate = (function( Panel, Table ) ACFEngineGUICreate( Table ) end or nil)
		Engine220V10.guiupdate = function() return end
	end
MobilityTable["22.0L-V10"] = Engine220V10
-- Spankels
...
local Engine48I6 = {}
	...
	Engine48I6.peakminrpm = 2900
	Engine48I6.peakmaxrpm = 4700
...
local Engine70V12 = {}
	...
	Engine70V12.peakminrpm = 3700
	Engine70V12.peakmaxrpm = 6200
