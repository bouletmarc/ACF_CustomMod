...
ACF_DefineEngine( "18.0-V8", {
	...
	desc = "American Ford GAA V8, decent overall power and torque and fairly lightweight",
...
ACF_DefineEngine( "7.8-V8", {
	name = "7.8L V8 Diesel",
	desc = "Utility grade V8 diesel, has a good, wide powerband",
	model = "models/engines/v8m.mdl",
...
ACF_DefineEngine( "19.0-V8", {
	...
	desc = "Heavy duty diesel V8, used for heavy construction equipment",
	model = "models/engines/v8l.mdl",
