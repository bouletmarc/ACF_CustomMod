...
local function CreateSoundBrowser(path)
	...
	SoundBrowserPanel:SetTitle("Engine Menu V3.3")
	...
	--####################
		...
		SliderT = ButtonsSidePanel:Add( "DNumSlider" )
			...
			SliderT:SetValue( GetConVar("acfmenu_data3") )
		...
		SliderIdle = ButtonsSidePanel:Add( "DNumSlider" )
			...
			SliderIdle:SetValue( GetConVar("acfmenu_data4") )
		...
		SliderPeakMin = ButtonsSidePanel:Add( "DNumSlider" )
			...
			SliderPeakMin:SetValue( GetConVar("acfmenu_data5") )
		...
		SliderPeakMax = ButtonsSidePanel:Add( "DNumSlider" )
			...
			SliderPeakMax:SetValue( GetConVar("acfmenu_data6") )
		...
		SliderLimit = ButtonsSidePanel:Add( "DNumSlider" )
			...
			SliderLimit:SetValue( GetConVar("acfmenu_data7") )
		...
		SliderFly = ButtonsSidePanel:Add( "DNumSlider" )
			...
			SliderFly:SetValue( GetConVar("acfmenu_data8") )
		...
		SliderWeight = ButtonsSidePanel:Add( "DNumSlider" )
			...
			SliderWeight:SetValue( GetConVar("acfmenu_data9") )
